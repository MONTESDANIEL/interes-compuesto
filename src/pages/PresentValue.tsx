...
import { pv as presentValue, PaymentDueTime } from "financial";

import CustomInput from "../components/CustomInput";
import Dropdown from "../components/Dropdown";
import ResultCard from "../components/ResultCard";

const PresentValue: React.FC = () => {
  ...
  const handleSubmitAnualidad = () => {
    ...
    console.log("Tasa por periodo final:", tasaPorPeriodoFinal);
  ...
  const handleSubmitInteres = () => {
    ...
    const PV =
      valorFuturoNum / Math.pow(1 + tasaPorPeriodoFinal, totalPeriodos);
